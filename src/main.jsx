...
function Theme({theme,setTheme}){
 const switchMode=()=>{
  ...
  window.setTimeout(()=>setTheme(theme==='dark'?'light':'dark'),180);
  window.setTimeout(()=>document.body.classList.remove('theme-flight'),820);
 };
