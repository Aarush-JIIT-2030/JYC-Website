...
const checks=[
 ['version is 18.9.x',['18.9.7','18.9.8','18.9.9','18.9.10','18.10.0','18.11.0','18.11.1','18.11.2'].includes(pkg.version)],
 ...
 ['service worker cache is 18.8',(sw.includes('jyc-cache-v18-11-final-product')||sw.includes('jyc-cache-v18-11-1-final-product'))||sw.includes('jyc-cache-v18-9-final')||sw.includes('jyc-cache-v18-9-5-jyc-first')],
